                ...
                <div class="flex gap-4">
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_cardiovascular" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_cardiovascular">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_cardiovascular" id="No" value="No"
                                           wire:model.blur="form.trastorno_cardiovascular">
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_respiratorio" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_respiratorio">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_respiratorio" id="No" value="No"
                                           wire:model.blur="form.trastorno_respiratorio">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_gastrointestinal" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_gastrointestinal">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_gastrointestinal" id="No" value="No"
                                           wire:model.blur="form.trastorno_gastrointestinal">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_oseo" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_oseo">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_oseo" id="No" value="No"
                                           wire:model.blur="form.trastorno_oseo">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_urologico" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_urologico">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_urologico" id="No" value="No"
                                           wire:model.blur="form.trastorno_urologico">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_hematologico" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_hematologico">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_hematologico" id="No" value="No"
                                           wire:model.blur="form.trastorno_hematologico">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_endocrino" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_endocrino">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_endocrino" id="No" value="No"
                                           wire:model.blur="form.trastorno_endocrino">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_neurologico" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_neurologico">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_neurologico" id="No" value="No"
                                           wire:model.blur="form.trastorno_neurologico">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
                ...
                <div class="flex gap-4 justify-start">
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="trastorno_ginecologico" id="Sí" value="Sí"
                                           wire:model.blur="form.trastorno_ginecologico">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="trastorno_ginecologico" id="No" value="No"
                                           wire:model.blur="form.trastorno_ginecologico">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
                    ...
                    <div class="mt-4 w-full">
                        ...
                        <div class="mt-4 flex-shrink">
                            <x-fieldset :disabled="!$enabled">
                                <div>
                                    <input type="radio" name="enfermedad_infectocontagiosa" id="Sí" value="Sí"
                                           wire:model.blur="form.enfermedad_infectocontagiosa">
                                    <label for="Sí">Sí</label>
                                </div>
                                <div>
                                    <input type="radio" name="enfermedad_infectocontagiosa" id="No" value="No"
                                           wire:model.blur="form.enfermedad_infectocontagiosa">
                                    <label for="No">No</label>
                                </div>
                            </x-fieldset>
