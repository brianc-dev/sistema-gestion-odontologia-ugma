<div class="w-3/4 bg-slate-400 break-inside-avoid items-start py-6 px-4 printable">
    <div>
    ...
    <form wire:submit="save" class="">
        <div class="flex gap-4">
            ...
            <div class="mt-4 w-full">
                ...
                <x-text-input :disabled="!$enabled" wire:model.live="form.nombre" id="nombre" class="block mt-1 w-full" type="text"
            ...
            <div class="mt-4 w-full">
                ...
                <x-text-input :disabled="!$enabled" wire:model.live="form.apellido" id="apellido" class="block mt-1 w-full" type="text"
        ...
        <div class="flex gap-4">
            ...
            <div class="mt-4 flex-shrink">
                ...
                <x-text-input :disabled="!$enabled" wire:model.live="form.edad" id="edad" class="block mt-1 w-full" type="text"
        ...
        <div class="flex gap-4">
            ...
            <div class="mt-4">
                ...
                <x-text-input :disabled="!$enabled" wire:model.live="form.contacto_emergencia" id="contacto_emergencia"
            ...
            <div class="mt-4">
                ...
                <x-text-input :disabled="!$enabled" wire:model.live="form.telefono_emergencia" id="telefono_emergencia"
                              class="block mt-1" type="tel"
