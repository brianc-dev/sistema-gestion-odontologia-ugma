<div class="w-3/4 bg-slate-400 break-inside-avoid items-start py-6 px-4">
    ...
    <div class="flex flex-col">
        ...
        <div class="mt-4">
            ...
            <textarea wire:model.live="form.zona_nasomaxilar"
                      id="zona_nasomaxilar"
        ...
        <div class="mt-4">
            <x-input-label for="zona_atm"
                           :value="__('Zona A.T.M')"/>
            <textarea wire:model.live="form.zona_atm"
                      id="zona_atm"
                      class="block mt-1 w-full rounded-lg border-none resize-y" type="text"
        ...
        <div class="mt-4">
            ...
            <textarea wire:model.live="form.zona_mandibular"
                      id="zona_mandibular"
                      class="block mt-1 w-full rounded-lg border-none resize-y" type="text"
        ...
        <div class="mt-4">
            ...
            <textarea wire:model.live="form.zona_dasi"
                      id="zona_dasi"
                      class="block mt-1 w-full rounded-lg border-none resize-y" type="text"
        ...
        <div class="mt-4">
            ...
            <textarea wire:model.live="form.estudio_periapicales"
        ...
        <div class="mt-4">
            ...
            <textarea wire:model.live="form.estudio_coronales"
