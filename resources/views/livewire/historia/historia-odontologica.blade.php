        ...
        <form wire:submit="save" class="">
            ...
            <div class="flex gap-4">
                <div class="mt-4 flex-1">
                    ...
                    <x-textarea :disabled="!$enabled" wire:model.live="form.descripcion_habitos" id="descripcion_habitos"
                              class="block mt-1 w-full rounded-lg border-none resize-y" type="text"
            ...
            <div class="flex gap-4">
                <div class="mt-4 flex-1">
                    ...
                    <x-textarea :disabled="!$enabled" wire:model.live="form.examen_extrabucal" id="examen_extrabucal"
                              class="block mt-1 w-full rounded-lg border-none resize-y" type="text"
            ...
            <div class="flex gap-4">
                <div class="mt-4 flex-1">
                    ...
                    <x-textarea :disabled="!$enabled" wire:model.live="form.examen_intrabucal" id="examen_intrabucal"
                              class="block mt-1 w-full rounded-lg border-none resize-y" type="text"
