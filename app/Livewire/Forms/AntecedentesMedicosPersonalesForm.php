...
class AntecedentesMedicosPersonalesForm extends Form
{
    ...
    #[Validate([
        'trastorno_cardiovascular' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_cardiovascular = '';

    #[Validate([
        'trastorno_respiratorio' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_respiratorio = '';

    #[Validate([
        'trastorno_gastrointestinal' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_gastrointestinal = '';

    #[Validate([
        'trastorno_oseo' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_oseo = '';

    #[Validate([
        'trastorno_urologico' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_urologico = '';

    #[Validate([
        'trastorno_hematologico' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_hematologico = '';

    #[Validate([
        'trastorno_endocrino' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_endocrino = '';

    #[Validate([
        'trastorno_neurologico' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_neurologico = '';

    #[Validate([
        'trastorno_ginecologico' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
    public string $trastorno_ginecologico = '';

    #[Validate([
        'enfermedad_infectocontagiosa' => [ 'regex:/Sí|No/']
    ], message: self::messages)]
